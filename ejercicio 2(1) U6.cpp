...
cursan la materia Programación Procedural: Nombre, Número de Registro y Resultado de un parcial (‘A’: Aprobado –
‘R’: Reprobado). La información se ingresa ordenada por Número de Registro.
...
int main(){
    FILE *archi;
    if ((archi=fopen("alumnosPP.data", "a+"))==NULL)
    {
